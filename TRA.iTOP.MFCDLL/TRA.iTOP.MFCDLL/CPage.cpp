...
//	Returns: nada
///////////////////////////////////////////////////////////////////////////
CPage::CPage(RECT rectDraw, CWrapCDC* pDC, int nMapMode)
{
...
int CPage::GetPrinterMode(CDC* pDC)
{
	...
	return Mode;
	****/
	return DMORIENT_PORTRAIT; //DMORIENT_LANDSCAPE
...
void CPage::ClearAllRegion()
{
	for(unsigned int y=0;y < m_RegionList.size(); ++y)
	{                 
		CPrintRegion*  pRegion=(CPrintRegion*) m_RegionList.at(y);
		delete pRegion;
	}
	m_RegionList.clear();
}
