...
typedef vector <CPrintRegion*>			ARR_PRINT_REGION;
typedef ARR_PRINT_REGION::iterator		THE_PRINT_REGION;
...
{
public:
	CPage(RECT rectDraw, CWrapCDC* p_Dc, int MapMode=MM_ANISOTROPIC);
	virtual	~CPage();
...
protected:
	...
	friend CPrintTable;
public:
	CUxPrinter ThePrinter;		//	low level printer functions
