...
void CUxPrinter::FillRect(PRTTYPE *ps)
{
...
//	Returns:
///////////////////////////////////////////////////////////////////////////
void CUxPrinter::DrawRect(PRTTYPE *ps,int LineSize)
{
	    HPEN   hOldPen, hPen;
	    HBRUSH hOldBrush, hBrush;
	    int   nLineWidth;
...
//	Returns:
///////////////////////////////////////////////////////////////////////////
void CUxPrinter::DrawLine(PRTTYPE *ps,int LineSize)                    
{
	    HPEN  hOldPen, hPen;
	    POINT pt[2];
	    int   nPenStyle;
...
//	Returns:
///////////////////////////////////////////////////////////////////////////
int CUxPrinter::PrintText(PRTTYPE *ps,double LineSpacing)
{         
	    LOGFONT	      lf;
...
//	Returns:
///////////////////////////////////////////////////////////////////////////
int CUxPrinter::GetPrintInfo(PRTTYPE *ps,double LineSpacing)
{         
	    LOGFONT	      lf;
	    HFONT	      hOldFont, hFont;
	    int		      saveContext;
